...
from app.config import SARVAM_API_KEY, GEMINI_API_KEY, OPENAI_API_KEY
...
SUPPORTED_CODES = {"en-IN", "hi-IN", "ta-IN", "te-IN", "kn-IN", "ml-IN", "mr-IN", "bn-IN", "gu-IN", "pa-IN"}
...
def translate(text: str, source_lang: str, target_lang: str) -> str:
    """Translate text using Gemini or OpenAI, falling back to English-safe text on failure."""
    if not text:
        return ""
    ...
    messages = [
        {
            "role": "system",
            "content": f"You are a highly accurate medical translator. Translate the following user text from {source} to {target}. ONLY return the translated text without any quotes, conversational tags, or markdown format strings.",
        },
